...
import { SidebarOverview } from "@/components/layout/sidebar-overview";
    ...
    <aside className="relative flex h-dvh w-[280px] shrink-0 flex-col overflow-hidden border-r border-white/10 bg-[#0b1224] text-white shadow-2xl shadow-indigo-950/40">
      ...
      <div className="relative z-10 p-4">
        ...
        <button
          type="button"
          onClick={logout}
          className="mt-3 flex w-full items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/5 px-3 py-2.5 text-sm font-medium text-indigo-100 transition hover:bg-white/10"
        >
